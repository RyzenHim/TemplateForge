        ...
        <div className="grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_320px]">
          <div className="space-y-5">
            <p className="max-w-2xl text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              Edit configurations and capabilities for this application. Once ready, click Save changes.
            </p>
            ...
            >
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <Field label="Package name" hint="Cannot be modified" error={errors.packageName?.message}>
                  <input
            ...
            <div className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <div className="mt-4 flex flex-col items-center">
                <div
                  ...
                  style={{
                    borderColor:
                      values.branding?.primaryColor || "#09090b",
                  }}
                >
                  <div
